...
public class EmailNotificationService : IEmailNotificationService
{
    ...
    {
        var usersWithNotifsCount = await _userManager.Users.Select(user => new { UserName = user.UserName, Email = user.Email, PlannedCount = user.PlannedDateNotifs.Count, RepliedCount = user.RepliedNotifs.Count, FollowedCount = user.FollowedNotifs.Count }).ToListAsync();
