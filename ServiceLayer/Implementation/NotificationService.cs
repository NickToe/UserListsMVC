...
public class NotificationService : INotificationService
{
  ...
  public async Task Remove(string userId, NotifType notifType, int? notifId)
  {
    switch (notifType)
    {
      ...
      case NotifType.Planned: await ClearPlannedNotif(userId, notifId);
        break;
      case NotifType.Replied: await ClearRepliedNotif(userId, notifId);
        break;
      case NotifType.Followed: await ClearFollowedNotif(userId, notifId);
        break;
